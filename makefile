...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  BreakController.o ButtonInputModule.o CCSController.o Decrease.o Increase.o ONOFFController.o OutputModule.o PedalController.o Resume.o Set.o registerCCS.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
BreakController.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/BreakController.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
ButtonInputModule.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/ButtonInputModule.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
CCSController.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/CCSController.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Decrease.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Decrease.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Increase.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Increase.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
ONOFFController.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/ONOFFController.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
OutputModule.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/OutputModule.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
PedalController.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/PedalController.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Resume.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Resume.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Set.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Set.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
registerCCS.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/registerCCS.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
BreakController.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/BreakController.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/BreakController.h \
...
ButtonInputModule.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/ButtonInputModule.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/ButtonInputModule.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
CCSController.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/CCSController.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/CCSController.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
Decrease.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Decrease.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Decrease.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
Increase.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Increase.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Increase.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
ONOFFController.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/ONOFFController.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/ONOFFController.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
OutputModule.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/OutputModule.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/OutputModule.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
PedalController.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/PedalController.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/PedalController.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
Resume.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Resume.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Resume.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
Set.o: /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Set.cpp \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/Set.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
registerCCS.o: \
 /cygdrive/C/eclipse/workspace/zzcruisecontrolsystem/registerCCS.cpp \
